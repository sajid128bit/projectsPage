...
class App extends Component {
  ...
  render() {
    ...
    const updatedProjectList = projectsList.filter(eachProject =>
      eachProject.category.includes(tabSelected),
    )
    return (
      <div className="app-container">
        ...
        <ul className="project-list-container">
          {updatedProjectList.map(projectDetails => (
            <ProjectItem
